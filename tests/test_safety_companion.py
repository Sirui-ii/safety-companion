...
class SafetyCompanionTests(unittest.TestCase):
    ...
    def test_web_server_has_crisis_guardrails(self):
        ...
        self.assertIn("Add your phone number", page)
        self.assertIn("First name", page)
        self.assertIn("Last name", page)
        self.assertIn("Phone number", page)
        self.assertIn("Email", page)
        self.assertIn("text or call me", page)
        self.assertIn("Subscribe me to Luulu email updates", page)
        self.assertIn("Unlock Luulu", page)
        self.assertIn("+1 (415) 908-5000", app)
        self.assertIn("No recordings", page)
        self.assertIn("No recordings", page)
        self.assertIn("people used Luulu", page)

...
class SafetyCompanionTests(unittest.TestCase):
    ...
    def test_web_server_has_crisis_guardrails(self):
        ...
        self.assertIn("Early days with Luulu", page)
        self.assertIn("we will keep you posted as we grow", page)
        self.assertIn("Stay tuned for our events with Luulu", page)
        self.assertIn("bring people up from darkness", page)
        ...
        self.assertIn("Send me Luulu updates as she grows", page)
        self.assertIn("Get on the List", page)

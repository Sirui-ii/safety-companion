...
class SafetyCompanionTests(unittest.TestCase):
    ...
    def test_web_server_has_crisis_guardrails(self):
        ...
        self.assertIn("gentle ways back into community", page)
        self.assertIn("feel a little more ready again", page)
        ...
        self.assertIn("Send me Luulu updates, gatherings, and gentle phone reminders", page)
